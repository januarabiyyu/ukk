    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
                ...
                <li id="nav_user"><a href=<?php echo base_url("admin"); ?>><i class="fa fa-table"></i> Data User</a></li>
                <li id="nav_rute"><a href=<?php echo base_url("rute"); ?>><i class="fa fa-table"></i> Data Rute</a></li>     
        </ul>
      </section>
      <!-- /.sidebar -->
    </aside>
          ...
          <div class="box">
            ...
            <form  action=<?php echo base_url("crud/update_rute"); ?> method="post">
              ...
              <div class="form-group">
                  ...
                  <input type="hidden" class="form-control" name="id" value=<?php echo $su->id;?>  />
									<input type="date" class="form-control" name="depart_at" value="Select date" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Select date';}"value=<?php echo $su->depart_at;?> /> 
                </div>
                 <div class="form-group">
                  <label>Rute from</label>
                  <input type="text" class="form-control" name="rute_from" value=<?php echo $su->rute_from;?> />
                </div>
                  <div class="form-group">
                  <label >Rute to</label>
                  <input type="text" class="form-control" name="rute_to" value=<?php echo $su->rute_to;?> />
                </div>
                  <div class="form-group">
                  <label >Price</label>
                  <input type="text" class="form-control" name="price" value=<?php echo $su->price;?> />
                </div>
                  <div class="form-group">
                  <label >Transpotation id</label>
                  <input type="text" class="form-control" name="transpotation_id" value=<?php echo $su->transpotation_id;?> />
                </div>
              </div>
              <!-- /.box-body -->
