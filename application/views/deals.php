...
<html>
<head>
<title>Deals | Travelad - Free HTML5 CSS3 Travel Hotel Template | Designmaz</title>
<!-- Custom Theme files -->
		...
		<div class="container">
			...
			<div class="banner-bottom-grids">
				<div class="col-md-4 weekend-grids">
					<div class="weekend-grid">
						<a href="products.html">
							<img src="<?php echo base_url();?>asset/images/w1.jpg" alt="" />
				...
				<div class="col-md-4 weekend-grids">
					<div class="weekend-grid">
						<a href="products.html">
							<img src="<<?php echo base_url();?>asset/images/w2.jpg" alt="" />
							<div class="deals-info-grid">
								<div class="deals-grids">
									<div class="col-md-8 deals-rating">
										<h3>Lorem ipsum dolor sit amet</h3>
				...
				<div class="col-md-4 weekend-grids">
					<div class="weekend-grid">
						<a href="products.html">
							<img src="<?php echo base_url();?>asset/images/w3.jpg" alt="" />
							<div class="deals-info-grid">
								<div class="deals-grids">
									<div class="col-md-8 deals-rating">
										<h3>Lorem ipsum dolor sit amet</h3>
			...
			<div class="banner-bottom-grids">
				<div class="col-md-4 weekend-grids">
					<div class="weekend-grid">
						<a href="products.html">
							<img src="<?php echo base_url();?>asset/images/w4.jpg" alt="" />
							<div class="deals-info-grid">
								<div class="deals-grids">
									<div class="col-md-8 deals-rating">
										<h3>Lorem ipsum dolor sit amet</h3>
